...
function setup() {
    ...
    ball1 = new BeachBall(500, 320);
    ball2 = new BeachBall(1500, 320);
    chair1 = new BeachChair(920, 500);
    umbrella1 = new Umbrella(150, 260, 300, 0)
    ball3 = new BeachBall(1020, 0);

    chair2 = new BeachChair(1280, 500);
    umbrella2 = new Umbrella(1100, 180, 300, 0);
    basket = new PicnicBasket(300, 500)
